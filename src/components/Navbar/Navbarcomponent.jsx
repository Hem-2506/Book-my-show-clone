...
const NavLg = () => {
   return (
       <>
       <div className="container mx-autopx-4 flex items center justify-between">
           ...
           <span className="text-gray-200 text-xs flex items-center hover:text-white cursor-pointer">Bengaluru <BiChevronDown />
                </span>
